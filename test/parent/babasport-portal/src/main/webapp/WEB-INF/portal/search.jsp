...
{
	window.location = 'http://localhost:8082/search?keyword=${keyword}&brandId='+brandId+'&sort=${sort2}&pageNum=1&pa=${pa}&pb=${pb}';
}
			...
			<div class="sl-b-selected J_brandSelected">
				<span class="crumbs-arrow">已选条件：</span>
					<c:forEach items="${map }" var="m">
						<a title="依琦莲（yiqilian）"  href="javascript:closeSpan('${m.key}');" class="crumb-select-item">
		...
		<div class="ml-wrap">
			<div id="J_filter" class="filter">
				<div class="f-line top">
					...
					综合排序<i></i></a><a href="javascript:;" class="">销量<i></i></a>
					<a href="javascript:serachKeyword('${sort}',1);" class="">价格<i></i></a>
					<a href="javascript:;" class="" >评论数<i></i></a><a href="javascript:;" class="">新品<i></i></a></div>
					<div class="f-search">
					...
					<span class="fp-text"><b>${pageProducts.pageNum}</b><em>/</em><i>${pageProducts.pages}</i>
					</span><a class="fp-prev disabled" href="javascript:;">&lt;</a>
					<a class="fp-next" onclick="serachKeyword('${sort2}',${pageProducts.pageNum+1})" href="javascript:;" title="使用方向键右键也可翻到下一页哦！">
					&gt;</a></div>
					<div class="f-result-sum">共<span id="J_resCount" class="num">${pageProducts.total}</span>件商品</div>
					<span class="clr"></span>
				</div>
				<div class="f-line">
					<div class="f-store">
	...
	<ul class="gl-warp clearfix" data-tpl="1">
		...
		<li data-sku="1711416562" class="gl-item">
			<div class="gl-i-wrap">
				<div class="p-img">
					<%-- <a href="javascript:;" 
					onclick="window.open('http://localhost:8083/html/product/${product.id}.html')" 
