...
function showLogin()
{
	window.location = "http://localhost:8081/login.aspx?returnUrl="
	...
	<div class="w">
		...
		<ul class="fr lh">
			<li class="fore1" id="loginbar" clstag="homepage|keycount|home2013|01b">
				<span id="userSpan"></span>您好！欢迎来到新巴巴运动网！
				<a href="javascript:;" id="login" onclick="showLogin()">[登录]</a>&nbsp;
				<a href="javascript:;" id="register" onclick="regist()">[免费注册]</a>
				<a href="javascript:;" id="logout" onclick="logout()">[退出]</a>
				<a href="javascript:;" id="order" onclick="myOrder()" >我的订单</a>
			</li>
